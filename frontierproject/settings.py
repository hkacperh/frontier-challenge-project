"""
Django settings for frontierproject project.
...
SECRET_KEY = 'django-insecure-k%j550#m()0%#d@&ss9-l_(6ila6+(mj@7utdm!ndr5^%uvke_'
...
ROOT_URLCONF = 'frontierproject.urls'
...
WSGI_APPLICATION = 'frontierproject.wsgi.application'
